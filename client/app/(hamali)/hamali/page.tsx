    ...
    <div className="fyro-page">
      ...
      <div className="fade-up fade-up-1" style={{ marginBottom: 16 }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'clamp(22px,4vw,30px)', color: 'var(--text)', letterSpacing: '-0.025em', margin: 0 }}>
          {user?.name?.split(' ')[0] || (loading ? '' : 'Hamali')}
        </h1>
      </div>
      ...
      {/* Profile completion */}
      {profileComplete < 100 && (
        <div className="fade-up fade-up-3 hamali-complete-card" style={{
          borderRadius: 14, padding: '14px 16px', marginBottom: 14
        }}>
          <p className="complete-title" style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 14, margin: '0 0 2px' }}>Complete your profile</p>
          <p className="complete-sub" style={{ fontFamily: 'var(--font-body)', fontSize: 12, margin: '0 0 10px' }}>Add skills and rates to receive jobs</p>
          <div style={{ height: 5, borderRadius: 999, background: 'rgba(13,148,136,0.12)' }}>
            <div className="complete-bar" style={{ height: '100%', borderRadius: 999, width: `${profileComplete}%`, transition: 'width 1s cubic-bezier(0.16,1,0.3,1)' }} />
          </div>
        </div>
      )}
